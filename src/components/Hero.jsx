...
const Hero = () => {
    ...
    return (
        <div
            ...
            className='min-w-screen min-h-[80vh] overflow-hidden'>
            <div className="text flex flex-col  pl-4 justify-center h-[80vh] md:pl-12 lg:w-[45vw] lg:absolute select-none">
                <h1 className="text-xl md:text-3xl font-light font-Helvetica mb-2">
                    Hi, I'm Aditya Pawar
                </h1>
                <h2 className="text-2xl md:text-5xl lg:text-6xl font-bold lg:leading-16 font-Poppins dark:text-neutral-200 text-neutral-800 mb-4">
                    Transforming ideas into interactive web experiences.
                </h2>
                <p className="text-base md:text-2xl w-[80vw] md:w-[60vw] lg:w-[45vw] font-normal mb-12">
