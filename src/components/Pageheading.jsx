    ...
    return (
        <>
            <div className="container hidden lg:block ">
                <div className={`projectHeading w-[100vw] md:h-[40vh] lg:h-screen flex flex-col items-center justify-between p-12 lg:p-28 ${theme === 'dark' ? 'lg:bg-center lg:bg-no-repeat bg-opacity-35' : ''}`}>
            ...
            <div className='lg:hidden bg-gradient-to-r from-[#8E05C2] to-[#CD50FD] bg-clip-text flex items-center justify-center w-screen text-5xl gap-5 pt-4 pb-12 px-4'>
                ...
                <h2 className='text-transparent md:text-7xl text-center font-JuliusSansOne'>
                    {title}
                </h2>
                <GoNorthStar className='text-[#8E05C2]' />
            </div>
