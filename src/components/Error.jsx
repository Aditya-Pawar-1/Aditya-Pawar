...
const Error = () => {
  ...
  return (
    <div>
      ...
      <div className={`w-screen h-[80vh] flex flex-col space-y-8 items-center justify-center ${theme === 'dark' ? 'bg-[#0A0A0A] text-neutral-50' : 'bg-[#F3F3FF] text-neutral-950'}`} >

        <img src="Error.svg" alt="Error page" className='w-[20%]'/>
