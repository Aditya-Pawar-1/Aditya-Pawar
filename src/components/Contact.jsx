    ...
    return (
        <>
            <div id='contact-section'>
                <Pageheading title={"Expolre Journey"} theme={theme} />
            </div>
            <div
            ...
            >
                ...
                <div className={`${cardClasses} bg-[#FF9500] pt-20 md:pt-24 pr-2 md:pr-6 hover:scale-105 hidden sm:block`}>
                    <h3 className='text-right font-semibold pb-4 font-Poppins text-xl md:text-3xl lg:text-5xl text-neutral-50'>
                        UI/UX <br /> Designer
                    </h3>
                </div>

                <div className={`${cardClasses} bg-[#FF0033] hover:scale-105 hidden sm:block`}>
                    <img className='pl-4 pt-6 scale-110' src='Arrow.svg' alt='Arrow Pointing towards Linkedin' />
                </div>
