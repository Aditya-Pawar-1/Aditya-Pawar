...
const Contact = () => {
    return (
        <div className='grid grid-cols-3 mx-48 gap-4 text-neutral-900'>
            <div className='bg-[#0077FF] pt-12 pl-6 rounded-xl h-[30vh]'>
                <h3 className='font-semibold font-[Poppins] text-5xl hover:scale-105 text-neutral-50'>Web Developer</h3>
            </div>
            <div onClick={() => handleClick('github')} className="col-span-2  pt-4 pl-24 rounded-xl h-[30vh] bg-[#FF0000] hover:scale-100">
            ...
            <div onClick={() => handleClick('behance')} className="col-span-2 pt-12 pl-14 rounded-xl h-[30vh] bg-[#2ecf0e]">
            ...
            <div className="bg-[#FF9500] pt-24 pr-6 rounded-xl h-[30vh] ">
                <h3 className='text-right font-semibold font-[Poppins] text-5xl text-neutral-50'>UI/UX Designer</h3>
            </div>

            <div className='bg-[#FF0033] rounded-xl h-[30vh]'>
                <img className='pl-4 pt-6 scale-125' src="Arrow.svg" alt="Arrow Pointing towards Linkedin" />
            </div>
            <div onClick={() => handleClick('Linkedin')} className="col-span-2 pt-12 pl-16 rounded-xl h-[30vh] bg-[#008CD9]">
