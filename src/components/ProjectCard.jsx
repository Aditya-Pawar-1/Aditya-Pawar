...
const ProjectCard = ({ title, description, tags, path, pathMin }) => {
    return (
        <div className="border-2 border-[#A000FF] drop-shadow-xl p-2 md:p-6 mb-5 rounded-md shadow-md text-left flex lg:flex-row flex-col select-none">
            <img src={path} alt='Project Image' className="hidden sm:block md:mb-4 object-fill lg:max-w-[25vw] xl:w-[35vw] max-h-[20vh] md:max-h-[40vh]" />
            <img src={pathMin} alt='Project Image' className="sm:hidden md:mb-4 object-fill lg:max-w-[25vw] xl:w-[35vw] max-h-[20vh] md:max-h-[40vh]" />
            <div className='p-6'>
