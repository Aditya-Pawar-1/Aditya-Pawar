...
const Project = () => {
    ...
    const projects = [
        ...
        {
            title: 'Heaven Homes',
            description: 'A UI/UX case study focused on designing an intuitive real estate platform that enhances the user experience for property buyers, sellers, and renters.',
